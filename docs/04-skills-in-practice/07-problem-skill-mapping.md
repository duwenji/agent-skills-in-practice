...
| **baoyu-diagram** | 図解生成 | アーキテクチャ図・フロー図をSVGで生成する | [4-4](04-baoyu-diagram.md) |
| **baoyu-infographic** | 視覚化 | データや概念を21レイアウト×17スタイルのインフォグラフィックで整理する | [4-5](05-baoyu-infographic.md) |
| **baoyu-comic** | コンテンツ制作 | 技術概念をコミック形式でわかりやすく伝える | [4-6](06-baoyu-comic.md) |
